-- ========================================
-- Migration: Adicionar suporte a biometria nas entregas de EPI
-- ========================================

-- Adicionar colunas de biometria na tabela entregas_epi
...
-- Criar índice para consultas por tipo de biometria
CREATE INDEX IF NOT EXISTS idx_entregas_biometria_tipo ON entregas_epi(biometria_tipo);

-- Criar tabela para armazenar credenciais biométricas dos funcionários
...
-- RLS para credenciais biométricas
